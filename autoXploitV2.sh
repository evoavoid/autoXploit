...
New_backdoor() {
	...
	echo ""
	echo "		Continue with the listener ?	[ Y / N ]"
	echo "________________________________________________________"
	read ChListener
	case $ChListener in
	
		y) echo " 		Introduce el lhost del listener" 
		read localhost
...
otheropt() {
	...
	echo "			\_____  || |\ \| || |    | |      _|| |/ /| |   | |   | |    | |  /\      \/  \ \             "
	echo "			      | || | \   || |   /  | |\ \   | | / | |   | |   | |   /  /  \ \    /\   / /               "
	echo "			      \ || /  \  || |__/  /| | \ \__| |/__| |___\ /___| |__/  /    \ \  / /  / /_____                 "
	echo "			       \||/    \_|\______/ |/   \__/(_______)\_______/\______/      \ \/ /  /________\                  "
	echo " 							   			 	     \  /"
	echo "											      \/	"
	echo ""
